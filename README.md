...
Najpre se prethodni podaci učitavaju koristeći metodu **createStatus()** klase **TwitterObjectFactory** koja kao parametar prima json objekat i na osnovu njega kreira instancu klase **Status**. 
